...
<View style={{flex: 1}}>
  ...
  <View style = {{flex: 1}}/>
    ...
    return(
      ...
      <View style={styles.descriptionBmi}>
        <Text style ={styles.descText}> People who fall into this category may be at risk of developing obesity.
    ...
    return(
      ...
      <View  style={styles.descriptionBmi}>
        <Text style ={styles.descText}> People who have BMI equal or over 30 may have obesity, which is defined as an abnormal or excessive accumulation of fat that may harm health.</Text>
      </View>
      <View style = {{flex: 1}}/>
    </View>
    )
    ...
    return(
      ...
      <View style={styles.descriptionBmi}>
        <Text style ={styles.descText}>
           People who have BMI equal or over 30 may have obesity, which is defined as an abnormal or excessive accumulation of fat that may harm health.</Text>
      </View>
      <View style = {{flex: 1}}/>
    </View>
    )
